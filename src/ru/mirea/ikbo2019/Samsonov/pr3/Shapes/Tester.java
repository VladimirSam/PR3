...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        Shape s1 = new Circle("RED", false, 4.4); // Upcast приводим тип класса наследника к классу родителя
        ...
        Shape s3 = new Rectangle("Green", false, 2.0, 3.0); // Upcast
        ...
        Shape s4 = new Square(5.5); // Upcast
